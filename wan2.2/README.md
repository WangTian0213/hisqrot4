...
# Animation
image = load_image("examples/animate/reference/image/src_ref.png")
pose_video = load_video("examples/animate/pose/video/src_pose.mp4")
face_video = load_video("examples/animate/face/video/src_face.mp4")
...
# Replacement
image = load_image("examples/replace/reference/image/src_ref.png")
pose_video = load_video("examples/replace/pose/video/src_pose.mp4")
face_video = load_video("examples/replace/face/video/src_face.mp4")
background_video = load_video("examples/replace/background/video/src_bg.mp4")
mask_video = load_video("examples/replace/mask/video/src_mask.mp4")
